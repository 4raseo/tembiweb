...
export function FeaturedRoomCard({ room }: FeaturedRoomCardProps) {
  return (
    <div className="flex flex-col md:flex-row bg-[#EAF0E5] rounded-lg overflow-hidden shadow-md">
      <div className="p-8 md:w-1/2 flex flex-col justify-center">
        ...
        <button className="bg-green-800 text-white font-semibold py-2 px-6 rounded-md w-fit hover:bg-green-900 transition-colors">
          View Details
        </button>
      </div>
